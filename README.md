...
- You must be in a raid or party group.
...
LockPort works in both raid and party groups. Custom message settings are saved by the game when you log out or reload the UI
